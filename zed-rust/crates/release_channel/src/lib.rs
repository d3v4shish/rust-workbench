...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Rust-Workbench-Dev",
        ReleaseChannel::Nightly => "Rust-Workbench-Nightly",
        ReleaseChannel::Preview => "Rust-Workbench-Preview",
        ReleaseChannel::Stable => "Rust-Workbench-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            ReleaseChannel::Nightly => "Rust Workbench Nightly",
            ReleaseChannel::Preview => "Rust Workbench Preview",
            ReleaseChannel::Stable => "Rust Workbench",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.rustworkbench.EditorDev",
            ReleaseChannel::Nightly => "dev.rustworkbench.EditorNightly",
            ReleaseChannel::Preview => "dev.rustworkbench.EditorPreview",
            ReleaseChannel::Stable => "dev.rustworkbench.Editor",
        }
    }
