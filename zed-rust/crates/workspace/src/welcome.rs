...
impl Render for WelcomePage {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let welcome_label = if self.fallback_to_recent_projects {
            "Welcome back to Rust Workbench"
        } else {
            "Welcome to Rust Workbench"
        };
                ...
                v_flex()
                        ...
                        h_flex()
                            ...
                            .child(
                                v_flex().child(Headline::new(welcome_label)).child(
                                    Label::new("Rust, explained from compiler facts to safe designs")
                                        .size(LabelSize::Small)
                                        .color(Color::Muted)
                                        .italic(),
                                ),
                    ...
                    .child(
                        v_flex()
                            ...
                            .child(
                                Label::new("Rust Learning Debugger")
                                    .size(LabelSize::Large),
                            )
                            .child(
                                Label::new("Open a Rust project and choose Explain visually from a supported compiler diagnostic. Code and diagrams stay synchronized while the debugger shows the failing contract, ownership or type flow, memory relationships, nearby call context, repair tradeoffs, and a local concept checkpoint—without an AI or network dependency.")
                                    .size(LabelSize::Small)
                                    .color(Color::Muted),
                            ),
                    )
