...
pub enum RustOwnershipDisplayProfile {
    #[default]
    Focus,
    Learn,
    Full,
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum RustInlineDiagnosticMode {
    Off,
    #[default]
    Selected,
    All,
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum RustOwnershipHintScope {
    #[default]
    SelectedBinding,
    CurrentFunction,
    File,
...
pub struct RustOwnershipDisplayPreferences {
    #[serde(skip)]
    pub enabled: bool,
    pub profile: RustOwnershipDisplayProfile,
    pub inline_diagnostics: RustInlineDiagnosticMode,
    pub scope: RustOwnershipHintScope,
    ...
    pub show_invalid_uses: bool,
    pub show_last_uses: bool,
    pub show_borrow_ends: bool,
...
impl Default for RustOwnershipDisplayPreferences {
    fn default() -> Self {
        Self::focus()
    }
}

impl RustOwnershipDisplayPreferences {
    pub fn focus() -> Self {
        Self {
            enabled: false,
            profile: RustOwnershipDisplayProfile::Focus,
            inline_diagnostics: RustInlineDiagnosticMode::Selected,
            scope: RustOwnershipHintScope::SelectedBinding,
            ...
            show_moves: true,
            show_borrows: true,
            show_invalid_uses: true,
            show_last_uses: false,
            show_borrow_ends: false,
    ...
    pub fn learn() -> Self {
        Self {
            enabled: false,
            profile: RustOwnershipDisplayProfile::Learn,
            inline_diagnostics: RustInlineDiagnosticMode::Selected,
            scope: RustOwnershipHintScope::CurrentFunction,
    ...
    pub fn full() -> Self {
        Self {
            enabled: false,
            profile: RustOwnershipDisplayProfile::Full,
            inline_diagnostics: RustInlineDiagnosticMode::All,
            scope: RustOwnershipHintScope::File,
            show_type_hints: true,
    ...
    pub fn allows_row(&self, row: u32) -> bool {
        self.scope == RustOwnershipHintScope::File
            || self
                .focus_rows
                .iter()
...
pub struct Editor {
    ...
    rust_ownership_display: RustOwnershipDisplayPreferences,
...
impl Editor {
    ...
    fn new_internal(
        ...
        let mut editor = Self {
            ...
            rust_ownership_display: RustOwnershipDisplayPreferences::default(),
