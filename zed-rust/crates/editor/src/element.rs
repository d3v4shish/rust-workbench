...
use crate::{
    ...
    MAX_LINE_LEN, MINIMAP_FONT_SIZE, PageDown, PageUp, Point, RowExt, RowRangeExt,
    RustInlineDiagnosticMode, Selection, SelectionDragState, SizingBehavior, SoftWrap, ToPoint,
...
impl EditorElement {
    ...
    fn layout_inline_diagnostics(
        ...
        let rust_display = self
            .editor
            .read(cx)
            .rust_ownership_display_preferences()
            .clone();
        ...
        let diagnostics_by_rows = self.editor.update(cx, |editor, cx| {
            ...
            editor
                ...
                .filter(|(_, diagnostic)| match rust_display.inline_diagnostics {
                    _ if !rust_display.enabled => true,
                    RustInlineDiagnosticMode::Off => false,
                    RustInlineDiagnosticMode::All => true,
                    RustInlineDiagnosticMode::Selected => {
                        rust_display.allows_row(diagnostic.start.row)
                    }
                })
