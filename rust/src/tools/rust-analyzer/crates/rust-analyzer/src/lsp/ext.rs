...
impl Request for OwnershipModelRequest {
    type Params = lsp_types::TextDocumentPositionParams;
    type Result = OwnershipModelResult;
    const METHOD: LspRequestMethod<'_> = LspRequestMethod::new("rust-analyzer/ownershipModel");
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}

pub enum OwnershipProblemsRequest {}

impl Request for OwnershipProblemsRequest {
    type Params = TextDocumentIdentifier;
    type Result = OwnershipProblemsResult;
    const METHOD: LspRequestMethod<'_> = LspRequestMethod::new("rust-analyzer/ownershipProblems");
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
impl Request for OwnershipRepairRequest {
    ...
    type Result = Option<CodeAction>;
    const METHOD: LspRequestMethod<'_> = LspRequestMethod::new("rust-analyzer/ownershipRepair");
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}

pub enum OwnershipValidateRepairRequest {}

impl Request for OwnershipValidateRepairRequest {
    type Params = OwnershipRepairParams;
    type Result = OwnershipRepairValidationResult;
    const METHOD: LspRequestMethod<'_> =
        LspRequestMethod::new("rust-analyzer/ownershipValidateRepair");
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ClientToServer;
}
...
#[serde(rename_all = "camelCase")]
pub struct OwnershipProblemsResult {
...
pub struct OwnershipModelResult {
    ...
    pub events: Vec<OwnershipModelEvent>,
    #[serde(default)]
    pub value_trace: Vec<OwnershipValueTraceStep>,
    pub repairs: Vec<OwnershipModelRepair>,
    ...
    pub c_sketch: Option<OwnershipModelCSketch>,
}
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelBody {
    pub body_id: u64,
    pub name: String,
    pub range: Range,
    pub blocks: Vec<OwnershipModelBlock>,
    pub provenance: String,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelBlock {
    pub basic_block: u32,
    pub range: Range,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelBinding {
    pub id: String,
    pub body_id: u64,
    pub name: String,
    pub range: Range,
    ...
    pub memory_layers: Vec<OwnershipModelMemoryLayer>,
    pub provenance: String,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelMemoryLayer {
    pub kind: String,
    pub storage: String,
    pub label: String,
    pub type_name: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelLoan {
    pub body_id: u64,
    pub loan_id: u32,
    pub kind: String,
    pub name: String,
    pub place: String,
    pub reserve: OwnershipModelLoanPoint,
    pub activation: Option<OwnershipModelLoanPoint>,
    pub live_points: Vec<OwnershipModelLoanPoint>,
    pub end_points: Vec<OwnershipModelLoanPoint>,
    pub truncated: bool,
    pub provenance: String,
}
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelCSketch {
    pub title: String,
    pub code: String,
    pub warning: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelEvent {
    pub event_id: String,
    pub body_id: u64,
    pub basic_block: u32,
    pub statement_index: u32,
    ...
    #[serde(default)]
    pub destination: Option<OwnershipModelEventDestination>,
}

#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelEventDestination {
    pub kind: String,
    pub label: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelRepair {
    pub id: String,
    pub title: String,
    pub strategy: String,
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelRepairEffects {
...
pub enum OwnershipModelChangedNotification {}

impl Notification for OwnershipModelChangedNotification {
    type Params = OwnershipModelChangedParams;
    const METHOD: LspNotificationMethod<'_> =
        LspNotificationMethod::new("rust-analyzer/ownershipModelChanged");
    const MESSAGE_DIRECTION: MessageDirection = MessageDirection::ServerToClient;
}

#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct OwnershipModelChangedParams {
    pub uri: Uri,
    pub schema_version: u32,
    pub status: String,
    pub source_hash: String,
