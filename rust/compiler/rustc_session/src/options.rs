...
options! {
    ...
    borrowck_autofix: Option<PathBuf> = (None, parse_opt_pathbuf, [UNTRACKED],
        "write conservative borrow-checker repairs to PATH and compile through a source overlay"),
    borrowck_autofix_wrapper_variants: bool = (false, parse_bool, [UNTRACKED],
        "also compile isolated Rc and RefCell borrow-checker repair variants"),
    borrowck_ownership_events: bool = (false, parse_bool, [UNTRACKED],
        "emit machine-readable MIR ownership events for editor integrations"),
    borrowck_ownership_model: Option<PathBuf> = (None, parse_opt_pathbuf, [UNTRACKED],
        "write a versioned MIR ownership model to PATH for editor integrations"),
    borrowck_wrapper_suggestions: bool = (false, parse_bool, [UNTRACKED],
        "validate ownership-wrapper borrow-checker repairs and emit editor suggestions"),
