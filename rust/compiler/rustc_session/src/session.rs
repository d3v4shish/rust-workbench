...
use crate::borrowck_repair::BorrowckRepairCollector;
...
pub struct Session {
    ...
    /// Conservative, opt-in source edits collected from borrow-checker diagnostics.
    pub borrowck_repairs: BorrowckRepairCollector,
}
...
pub fn build_session(
    ...
    let sess = Session {
        ...
        pointer_auth_config,
        borrowck_repairs: Default::default(),
    };
